...
class My_EweiShopV2Page extends AppMobilePage
{
	public function getlist()
	{
		...
		foreach ($coupons as $i => &$row ) {
			...
			unset($row['timelimit'], $row['coupontype'], $row['timestart'], $row['timeend'], $row['enough'], $row['backtype'], $row['deduct'], $row['discount'], $row['backmoney'], $row['backcredit'], $row['backredpack'], $row['bgcolor'], $row['merchid'], $row['settitlecolor'], $row['titlecolor'], $row['past'], $row['merchname'], $row['css'], $row['backstr'], $row['backpre'], $row['_backmoney']);
		}
