			...
			if (($message_type == TM_GLOBONUS_PAY) && empty($usernotice['globonus_pay'])) {
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '分红发放通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的分红打款成功', 'color' => '#000000'),
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '股东等级升级通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的股东等级从' . $data['oldlevel']['levelname'] . '升级到' . $data['newlevel']['levelname'] . ',特此通知！', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '成为股东通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '恭喜您成为股东', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
