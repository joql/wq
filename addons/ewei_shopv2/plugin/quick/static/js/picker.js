define(['core', 'tpl', 'biz/member/cart', 'biz/plugin/diyform'], function (core, tpl, cart, diyform) {
    ...
    modal.init = function () {
        ...
        modal.container.container.find('.option-picker').css('max-height', height - 150);
        modal.container.container.find('.option-picker .option-picker-options').css('max-height', height - 325)
    };
