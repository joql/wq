	...
	class CommissionModel extends PluginModel
	{
				...
				foreach ($goods as &$cinfo ) {
					...
					if ($update) {
						...
						if (p('task')) {
							...
							p('task')->checkTaskProgress((int) $commissions['level1'], 'pyramid_money', 0, $m1['openid']);
							p('task')->checkTaskProgress((int) $commissions['level2'], 'pyramid_money', 0, $m2['openid']);
							p('task')->checkTaskProgress((int) $commissions['level3'], 'pyramid_money', 0, $m3['openid']);
						}
		...
		public function checkAgent($openid = '')
		{
			...
			if ($parent_is_agent) {
				if ($parent['openid'] != $openid) {
					if (p('task')) {
						p('task')->checkTaskProgress(1, 'pyramid_num', 0, $parent['openid']);
		...
		public function checkOrderConfirm($orderid = '0')
		{
			...
			if (empty($become_child)) {
			 ...
			 else if (!(empty($order['officcode'])) && p('offic')) {
		...
		public function sendMessage($openid = '', $data = array(), $message_type = '')
		{
			...
			if (($message_type == TM_COMMISSION_AGENT_NEW) && empty($usernotice['commission_agent_new'])) {
				if ($tm['is_advanced']) {
					...
					$text = '您新增了一个下级' . $data['nickname'] . '！' . "\n" . date('Y-m-d H:i') . "\n";
					$message = array(
						'first'    => array('value' => '亲爱的' . $data['nickname'] . '，您新增了一个下级' . $data['nickname'], 'color' => '#ff0000'),
						'keyword1' => array('title' => '任务名称', 'value' => '下级付款通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的下级' . $data['nickname'] . '已经成功付款', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
				...
				if ($tm['is_advanced']) {
					...
					$text = '您的下级' . $data['nickname'] . '已付款！' . "\n" . date('Y-m-d H:i') . "\n";
					$message = array(
						'first'    => array('value' => '亲爱的' . $data['nickname'] . '，您的下级' . $data['nickname'] . '已付款', 'color' => '#ff0000'),
						'keyword1' => array('title' => '任务名称', 'value' => '下级付款通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的下级' . $data['nickname'] . '已经成功付款', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						'first'    => array('value' => '亲爱的' . $data['nickname'] . '，您的下级' . $data['nickname'] . '已确认收货', 'color' => '#ff0000'),
						'keyword1' => array('title' => '任务名称', 'value' => '提现申请提交通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的佣金提现申请已提交', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '提现申请审核通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的佣金提现申请审核完成', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => $set['texts']['commission1'] . '打款通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的佣金提现已打款成功', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => $set['texts']['agent'] . '等级升级通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '您的分销商等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['oldlevel']['levelname'] . '特此通知!', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
				...
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword1' => array('title' => '任务名称', 'value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#000000'),
						'keyword2' => array('title' => '任务类型', 'value' => '成为分销商通知', 'color' => '#000000'),
						'keyword3' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
						'remark'   => array('value' => "\n" . '感谢您的支持', 'color' => '#000000')
						);
					$toopenid = $openid;
			...
			if ($tm['is_advanced'] && (($tag == 'commission_agent_new') || ($tag == 'commission_order_pay') || ($tag == 'commission_order_finish'))) {
				$res = $this->getAgentsByMember($toopenid, intval($tm[$tag . '_advanced_notice']));
				...
				foreach ($res as $key => $value ) {
					if ($key == 0) {
						...
						if ($tag == 'commission_order_pay') {
						 ...
						 else if ($tag == 'commission_order_finish') {
