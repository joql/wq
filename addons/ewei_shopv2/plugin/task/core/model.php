...
class TaskModel extends PluginModel
{
	...
	public function taskPickMessage($openid, $record)
	{
		...
		$message = array(
			...
			'keyword1' => array('title' => '任务名称', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword2' => array('title' => '任务类型', 'value' => $type['type_name'], 'color' => '#000000'),
			'keyword3' => array('title' => '完成时间', 'value' => '尚未完成', 'color' => '#ff0000'),
	...
	public function taskFinishMessage($openid, $record)
	{
		...
		$message = array(
			...
			'keyword1' => array('title' => '任务名称', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword2' => array('title' => '任务类型', 'value' => $type['type_name'], 'color' => '#000000'),
			'keyword2' => array('title' => '完成时间', 'value' => date('Y-m-d H:i'), 'color' => '#ff0000'),
			'remark'   => array('value' => '如有疑问请联系在线客服', 'color' => '#000000')
			);
		$url = mobileUrl('task.reward', array(), 1);
		$text = "亲爱的[用户昵称]，您的任务已经完成！快去查看您的奖励吧~~\n";
		$remark = '<a href=\'' . $url . '\'>点击查看详情</a>';
		$text .= $remark;
		$datas = $this->getNoticeDatas($record);
		m('notice')->sendNotice(array('openid' => $openid, 'tag' => $tag, 'default' => $message, 'cusdefault' => $text, 'url' => $url, 'datas' => $datas));
	...
	public function posterPickMessage($openid, $record)
	{
		...
		$message = array(
			...
			'keyword1' => array('title' => '任务名称', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword2' => array('title' => '任务类型', 'value' => '海报任务', 'color' => '#000000'),
			'keyword3' => array('title' => '完成时间', 'value' => '尚未完成', 'color' => '#ff0000'),
	...
	public function posterFinishMessage($openid, $record)
	{
		...
		$message = array(
			...
			'keyword1' => array('title' => '任务名称', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword2' => array('title' => '任务类型', 'value' => '海报任务', 'color' => '#000000'),
			'keyword3' => array('title' => '完成时间', 'value' => $this_member['nickname'], 'color' => '#000000'),
	...
	public function taskPosterFollowMessage($openid, $record, $nickname = '')
	{
		...
		$message = array(
			...
			'keyword1' => array('title' => '任务名称', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword2' => array('title' => '任务类型', 'value' => '海报任务', 'color' => '#000000'),
			'keyword3' => array('title' => '完成时间', 'value' => date('Y-m-d H:i'), 'color' => '#ff0000'),
			'remark'   => array('value' => '快去查看您的奖励吧~~', 'color' => '#000000')
			);
		$url = mobileUrl('task.reward', NULL, 1);
