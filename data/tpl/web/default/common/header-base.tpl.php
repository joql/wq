...
<head>
	...
	<meta name="description" content="<?php  if(empty($_W['page']['copyright']['description'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>公众平台自助引擎（www.we7.cc），简称微擎，微擎是一款免费开源的微信公众平台管理系统，是国内最完善移动网站及移动互联网技术解决方案。<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['description'];?><?php  } ?>" /><meta name="author" content="123123123" />
	...
	<link href="./resource/css/bootstrap.min.css?v=20180203&?id=CmHtml" rel="stylesheet">
	<link href="./resource/css/common.css?v=20180203&?id=CmHtml" rel="stylesheet">
